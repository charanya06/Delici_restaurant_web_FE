          ...
          >
            <ul className=' navbar-nav mx-auto ' >
              <li className='nav-item px-5 nav-link navbar-icon navbar-font'>
                <a href='/Delici_restaurant_web_FE' className='nav-link'>
                  Home
                </a>
              </li>
              <li className='nav-item px-5 nav-link navbar-icon navbar-font'>
                <a href='/Delici_restaurant_web_FE/menu' className='nav-link'>
                  Menu
                </a>
              </li>
              <li className='nav-item px-5 nav-link navbar-icon navbar-font'>
                <a href='/Delici_restaurant_web_FE/reservation' className='nav-link'>
                  Reservation
                </a>
              </li>
            </ul>
